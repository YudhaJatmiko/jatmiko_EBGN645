...
p0 'initial price'
r0 'initial reserves'
q0 'initial extraction rate'
c 'extraction cost'
disc_rate 'discount rate'
disc(t) 'discount factor'
;

*cost assumption 1000
*discount rate assumption 5%
*initial price from latest data (June 2025)
p0 = 15003.11;
...
*variables
positive variable
q(t) 'quantity of extraction in period t'
reserve(t) 'remaining reserves by the end of period t';
...
parameter
cum_extraction(t) 'cumulative extraction'
depletion 'percentage depleted'
;
...
display
hotelling.modelstat, hotelling.solvestat, NPV.l, q.l, reserve.l, cum_extraction, depletion
;
